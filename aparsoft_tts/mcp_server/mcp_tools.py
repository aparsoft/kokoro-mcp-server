...
def normalize_path(path_str: str) -> Path:
    ...
    Example:
        normalize_path("\\\\wsl.localhost\\\\Ubuntu\\\\home\\\\user\\\\test.wav")
    """
...
# ==============================================================================
# MCP tools: generate_speech, list_voices, batch_generate
# ==============================================================================
# Tools provide specific functionalities that can be invoked by the MCP client.
# Each tool is defined as an async function with type-annotated parameters
# and return types. FastMCP automatically generates the tool schema from
